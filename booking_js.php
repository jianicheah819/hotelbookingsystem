...
$sql = "SELECT * from booking LIMIT $start_from, $per_page_record";
...
$total_pages = ceil($total_rows / $per_page_record);   
  $pagLink = "";       
      if($page>=2){   
            echo "<a href='booking_js.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='booking_js.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='booking_js.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='booking_js.php?page=".($page+1)."'>  Next </a>";   
        }   
 ...
 <div class="inline">   
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = 'booking_js.php?page='+page;   
    }   
  </script> 	 
</body>
</html>
