...
$sql="SELECT * from payment ORDER BY pay_id ASC LIMIT $start_from, $per_page_record";
$result_data = mysqli_query($conn, $sql);

?>

<P><strong><center> Payment Lists</strong></center>
...
<td align="center" bgcolor="#9932CC"><strong>Edit</strong></td>
<td align="center" bgcolor="#9932CC"><strong>Delete</strong></td>
</tr>
  </thead>
<?PHP
...
echo "<td>","<a href=\"form_update_pay.php?pay_id=$pay_id\">Edit</a>";

echo "<td>","<a  href=\"pros_delete_pay.php?pay_id=$pay_id\">Delete</a>";
...
$total_pages = ceil($total_rows / $per_page_record);   
  $pagLink = "";       
      if($page>=2){   
            echo "<a href='edit_delete_pay.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='edit_delete_pay.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='edit_delete_pay.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='edit_delete_pay.php?page=".($page+1)."'>  Next </a>";   
        }   
 ...
 <div class="inline">   
  ...
  <script>   
    ...
    {   
        ...
        window.location.href = 'edit_delete_pay.php?page='+page;   
    }   
  </script> 
</body>
</html>